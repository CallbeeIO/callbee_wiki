...
!!! warning "Важное замечание"
    Если __сервер телефонии АТС__ находится в __одной локальной сети__ с __коробочной версией__ Битрикс24, то __можно__ указывать __локальный IP-адрес АТС__, но в таком случае __индикатор доступности__ будет гореть __красным__ цветом (указывает что ссылка некорректна).
