...
* #### __(1) CRM&PBX__
* __(1.1) CRM System__ - Выберете CRM систему в которой Вы работаете.
...
* __(2.2) Asterisk AMI Username__ - Укажите AMI Username (Смотрите раздел Настройка AMI Asterisk).
* __(2.3) Asterisk AMI Secret__ - Укажите AMI Secret (Смотрите раздел Настройка AMI Asterisk).
...
#### В интеграции предусмотрены 4 страницы:
