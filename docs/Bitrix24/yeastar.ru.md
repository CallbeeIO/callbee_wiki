...
* Установите переключатель __FTP/API (7)__ в нужное положение в завимисти от __модели__ станции Yeastar       
  ...
  * __Convert to mp3 (8)__ - Конвертация записи в __mp3__
    ...
    !!! warning "Важное замечание"
        ...
        * При __трансфере звонка с сопровождением__ будет корректно __записан весь разговор__ (необходимо чтобы была __включена запись линии__) и __проброшена__ запись __всего разговора__ в CRM на __последнего поговорившего__ в версии интеграции начиная с v2.0.
