# Создание личного кабинета в CALLBEE.IO: Пошаговая инструкция
...
2.  Найдите и нажмите кнопку **"Create an Account/Создать аккаунт"** которая находится центре главной страницы.
...
2.  Найдите письмо от CALLBEE с темой "Подтверждение регистрации".
...
## Шаг 5: Первый вход в личный кабинет
...
## Шаг 4: Завершение настройки профиля (если необходимо)

После подтверждения электронной почты вы можете быть перенаправлены в личный кабинет. В некоторых случаях может потребоваться заполнить дополнительную информацию о себе или своей компании.

*   **Номер телефона (Необязательно):** Укажите номер телефона для связи.
*   **Сфера деятельности (Необязательно):** Укажите сферу деятельности вашей компании.
*   **Другие параметры:** Следуйте инструкциям на экране, чтобы заполнить необходимые поля.

## Шаг 6: Начните использовать CALLBEE!
