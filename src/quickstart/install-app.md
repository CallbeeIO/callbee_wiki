...
> [!NOTE] Требования
> АТС Yeastar серии **P** (P550/P560/P570) с активной лицензией **App Center**.

1. Откройте веб-интерфейс Yeastar P-series и перейдите в **App Center**
2. Найдите приложение **«Callbee | CRM Integration»**
3. Нажмите **«Установить»** и подтвердите установку
4. После установки откройте приложение и авторизуйтесь через аккаунт Callbee
